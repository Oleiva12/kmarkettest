import { LLMAgent, LLMAgentWorker } from '@llamaindex/core/agent';
...
class Ollama extends ToolCallLLM {
    static{
    ...
    async chat(params) {
        ...
        if (responseFormat && this.metadata.structuredOutput) {
            if (isZodSchema(responseFormat)) payload.format = zodToJsonSchema(responseFormat);
        }
        if (!stream) {
...
class OllamaAgentWorker extends LLMAgentWorker {
}
class OllamaAgent extends LLMAgent {
    constructor(params){
        const llm = params.llm ?? (Settings.llm instanceof Ollama ? Settings.llm : !params.model ? (()=>{
...
export { Ollama, OllamaAgent, OllamaAgentWorker, OllamaEmbedding, ollama };
